...
public class UserListAdapter extends RecyclerView.Adapter<UserListAdapter.UserViewHolder> {
	...
	public static class UserViewHolder extends RecyclerView.ViewHolder {
		...
		@BindView(R.id.network_item_iv_user_picture) ImageView mIvUserPicture;
		@BindView(R.id.network_item_tv_user_name) TextView mTvUserName;
		@BindView(R.id.network_item_tv_user_login) TextView mTvUserLogin;
		@BindView(R.id.network_item_tv_user_page) TextView mTvUserPage;
